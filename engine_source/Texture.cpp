...
Texture::Texture(const char* imageFile, GLenum textureType, GLenum filter, GLuint slot, GLenum format, GLenum pixelType/*, float scale*/)
{
	filepath = imageFile;
	type = textureType;
	set = true;
...
Texture::Texture(const char* imageFile, GLenum textureType, GLenum filter, GLenum format, GLenum pixelType/*, float scale*/)
{
	filepath = imageFile;
	type = textureType;
	set = true;
