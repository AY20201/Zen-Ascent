...
class Texture
{
	public:
		...
		Texture() = default;
		Texture(const char* imageFile, GLenum textureType, GLenum filter, GLuint slot, GLenum format, GLenum pixelType);
		Texture(const char* imageFile, GLenum textureType, GLenum filter, GLenum format, GLenum pixelType);
